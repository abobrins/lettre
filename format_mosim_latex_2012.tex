...
2 & 3 & 4 \\ \hline
\end{tabular}
\caption{\label{''étiquette''} Example of table caption}
\vspace{-0.5cm}
\end{center}
\end{table}
...
\begin{description}
  ...
  \item[] Durand, J.A., 1996. \textit{Ordonnancement dynamique et réactif dans les ateliers flow-shop hybrides : une approche à base d'algorithmes évolutionnistes hybrides}. Thèse de Doctorat, Université de Paris VI, France.
